...
<div class="container-fluid sticky-top" id="black">
    <nav class="navbar navbar-expand-lg p-0">
        <div class="container p-0">
            <a class="navbar-brand" href="index.php"><img src="images/logos/logo.png" loading="lazy"
                    style="width: 135px" alt="SAP" /></a>
                ...
                <div class="wrapper justify-content-end">
                    <div>
                        <ul class="navbar-nav align-items-center gap-4">
                            ...
                            <li class="nav-item">
                                <a class="nav-link font-color active" href="contactus.php">Contact us
                                </a>
                            </li>
                        </ul>
                    </div>
