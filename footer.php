<footer class="footerbg pt-4  pb-1 pad-zero">
        ...
        <div class="footer-top">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mt-4 mt-lg-0 mt-md-0">
                    ...
                    <div class="menu-footer-menu-container" data-aos="fade-up" data-aos-delay="100"
                        data-aos-duration="800" data-aos-easing="ease-in-out">
                    ...
                    <div class="contaienr" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1200"
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="d-flex align-items-baseline">
                                    ...
                                    <i class="bi bi-geo-alt-fill font-colors pe-4"></i>
                                    ...
                                    <a class="text-white fs-6 text-decoration-none py-2"
                                        ...
                                        Sri Matha, Undyapu, Belal Road, Ujire, Karnataka - 574 240</a>
                        ...
                        <ul class="info-share d-flex justify-content-start gap-4 pt-3 list-inline">
                            ...
                            <li class="list-inline-item font-colors">
                                ...
                                <a target="_blank" href="#" rel="nofollow"><i
                                        class="bi bi-linkedin font-colors fs-5"></i></a>
                            ...
                            <li class="list-inline-item font-colors">
                                ...
                                <a target="_blank" href="#" rel="nofollow"><i
                                        class="bi bi-google font-colors fs-5"></i></a>
